...
class FokkerPlanck2D_Aline_Bline(FokkerPlanck2DBase):
    ...
    Fokker-Planck model whish assumes that:
        1. Ax is anti-symmetric along vx=0 and independent of vy
        2. Ay = Ax^T
    ...
    def __repr__(self):
        return (
            f"FokkerPlanck2D_Aline_Bline(A=Array{self.A.shape}, B=Array{self.B.shape}, "
